...
CONFIG_REGISTRY: list[ConfigParam] = [
    ...
    ConfigParam("recipe_file", "HUD_RECIPE_FILE",
                str(PROJECT_ROOT / "data" / "recipes.json"), "str", "Features",
                "Path to recipe storage JSON file"),
    ConfigParam("cooking_session_ttl", "HUD_COOKING_SESSION_TTL", "3600", "int",
                "Features", "Cooking session timeout in seconds"),
